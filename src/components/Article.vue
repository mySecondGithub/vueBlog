<template>
	<div>
		...
		<div class="content">
			<div class="header clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>详细</p></div>
		    <div class="cont">
		    	<h3>{{articleData.title}}</h3>
		        <div class="time"><p>{{articleData.time | normalTime}} <span><img src="../assets/img/zan.png" alt="zan.png"/></span></p></div>
		...
		<div class="foot-btn">
			<ul>
		    	...
		    	<li class="xing"><a href="javascript:;">
		        	<i><img src="../assets/img/xing.png" alt="xing.pn"/></i>
		        </a></li>
		    	<li class="fx"><a href="javascript:;">
		        	<i><img src="../assets/img/fx.png" alt="fx.png"/></i>
		        </a></li>
		    </ul>
		</div>
	</div>
...
<style scoped>
	...
	.cont .text-box{ font-size:0.25rem;text-indent:2em;}
