<template>
	<div class="content">
	    ...
	    <div class="login-box">
	    	<p class="lsolid"></p>
	        <div class="login">
	        	<router-link to="/user-login">注册</router-link>
	        	<span></span>
	        	<router-link to="/user-reg">信息</router-link>
	        </div>
	        <p class="rsolid"></p>
	    </div>
	    <ul>
...
<style scoped>
	...
	.content h1{width:2.18rem;height:2.18rem; background:url(../assets/img/headimg.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:0.5rem;}
